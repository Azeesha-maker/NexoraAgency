      ...
      <div className='max-w-3xl mx-auto px-6 lg:px-8'>
        ...
        <form className='bg-gray-50 rounded-3xl p-8 shadow-sm' onSubmit={handleSubmit}>
          ...
          <textarea
            ...
            onChange={handleChange}
            className='border border-gray-300 rounded-xl p-3 w-full mb-6 h-32 resize-none focus:ring-2 focus:ring-primary focus:outline-none'
            required
          />
        ...
        <div className='mt-12 space-y-6 text-center'>
          ...
          <div className='flex justify-center gap-6'>
            ...
            <Link href='#' className='text-primary hover:underline flex items-center gap-1'>
              <Icon icon='tabler:message-circle' width='18' /> Chat
            </Link>
          </div>
        </div>
      </div>
