...
const girls: TeamMember[] = [
  { name: "Azeesha Ali", role: "IT Role , Front-End", photo: "/images/team/Azeesha.png", bio: "Azeesha builds robust, user-centric web applications with a passion for clean code and security.", skills: ["React", "Node.js", "TypeScript", "GraphQL"], linkedin: "https://linkedin.com/in/azeesha-ali", github: "https://github.com/azeesha", funFact: "Can debug in her sleep and still wake up with a smile" },
  { name: "Anzalna", role: "UI/UX Designer", photo: "images\\team\\Anzalna.png", bio: "Anzalna transforms complex ideas into intuitive, delightful digital experiences.", skills: ["Figma", "User Research", "Prototyping", "Design Systems"], linkedin: "http://www.linkedin.com/in/anzalna-ansari-6990b7329", funFact: "Believes every pixel has a purpose" },
  { name: "Aniqa Khan", role: "DevOps Engineer", photo: "/images/team/Aniqa.png", bio: "Aniqa keeps the lights on — automating deployments and ensuring zero downtime.", skills: ["Docker", "AWS", "CI/CD", "Terraform"], linkedin: "https://linkedin.com/in/arjun-patel", github: "https://github.com/arjunp", funFact: "Can deploy to production with one hand tied behind her back" },
  { name: "Simra Malik", role: "Frontend Developer", photo: "/images/team/Simra.png", bio: "Simra crafts pixel-perfect, accessible interfaces with a focus on performance and animation.", skills: ["React", "Next.js", "Tailwind CSS", "Framer Motion"], linkedin: "https://www.linkedin.com/in/simra-malik-ab452138b", github: "https://github.com/simraa", funFact: "Once animated an entire dashboard using only CSS — and it still works in IE11" },
];

const boys: TeamMember[] = [
  { name: "Saqib Khan", role: "Full Stack Developer", photo: "/images/team/Saqib.png", bio: "Saqib builds robust, user-centric web applications with a passion for clean code and security.", skills: ["Next.js", "Tailwind", "Framer Motion", "A11y"], linkedin: "https://linkedin.com/in/sofia-khan", github: "https://github.com/sofiak", funFact: "Secretly a CSS animation wizard" },
  { name: "Muhammad Mursaleen", role: "Backend Engineer", photo: "/images/team/Mursaleen.png", bio: "Mursaleen architects scalable systems that power millions of daily interactions.", skills: ["Go", "Kubernetes", "PostgreSQL", "Microservices"], linkedin: "https://linkedin.com/in/rahul-mehta", github: "https://github.com/rahulm", funFact: "Once optimized a database at 3 AM… for fun" },
];
...
export default function TeamPage(): JSX.Element {
  ...
  return (
    <>
      <motion.section variants={sectionFade} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} transition={{ duration: 0.7 }} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[var(--color-blue-50)] via-white to-[var(--color-purple-50)]">
        ...
        <div className="container mx-auto px-4 py-24 text-center relative z-10">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link href="/contact"><button className="rounded-lg bg-[var(--color-blue-600)] px-6 py-3 font-medium text-white transition hover:bg-[var(--color-blue-700)] cursor-pointer">Contact Our Experts</button></Link>
            <Link href="/careers"><button className="rounded-lg border border-[var(--color-gray-300)] bg-white px-6 py-3 font-medium text-[var(--color-gray-900)] transition hover:bg-[var(--color-gray-50)] cursor-pointer">View Careers</button></Link>
          </div>
        </div>
              ...
              <motion.article key={member.name + i} initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.12 }} transition={{ duration: 0.55, delay: i * 0.08 }} className="group relative overflow-hidden rounded-3xl bg-white/60 backdrop-blur-xl shadow-xl border border-white/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:bg-white/90">
                <div className="flex flex-col items-center p-8 text-center">
                  ...
                  <div className="flex justify-center gap-4 opacity-80 group-hover:opacity-100 transition">
                    ...
                    {member.github && <a href={member.github} target="_blank" rel="noreferrer"><Github className="h-5 w-5 text-[var(--color-gray-700)] hover:text-[var(--color-gray-900)] transition" /></a>}
                  </div>
      ...
      <motion.section variants={sectionFade} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.12 }} transition={{ duration: 0.7 }} className="py-24 bg-gradient-to-br from-[var(--color-blue-100)] via-[var(--color-purple-50)] to-[var(--color-blue-50)]">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="mb-16 text-center">
      ...
      <motion.section variants={sectionFade} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.12 }} transition={{ duration: 0.7 }} className="py-24 bg-gradient-to-br from-[var(--color-blue-100)] via-white to-[var(--color-purple-100)] text-[var(--color-gray-900)]">
        <div className="container mx-auto px-6 max-w-7xl">
      ...
      <motion.section variants={sectionFade} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.12 }} transition={{ duration: 0.7 }} className="py-24 bg-gradient-to-r from-[var(--color-blue-500)] to-[var(--color-skyblue-500)] text-black text-center">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/contact"><button className="rounded-lg bg-white text-[var(--color-blue-600)] px-8 py-3 font-medium transition hover:scale-105 hover:bg-[var(--color-blue-100)]">Contact Our Experts</button></Link>
            <Link href="/careers"><button className="rounded-lg border border-white px-8 py-3 font-medium text-blue transition hover:bg-white hover:text-[var(--color-blue-700)]">View Careers</button></Link>
          </div>
        </div>
      </motion.section>
    </>
