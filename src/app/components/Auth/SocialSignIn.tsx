    ...
    <>
      <div className="flex gap-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg p-3.5 hover:bg-white/80 bg-darkmode text-white hover:text-darkmode border border-darkmode"
        >
          Sign In
          <svg
            width="23"
