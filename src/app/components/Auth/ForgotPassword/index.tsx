...
const ForgotPassword = () => {
  ...
  return (
    <section className='bg-[var(--color-light-blue-bg)] py-14 dark:bg-dark lg:py-20'>
            ...
            <div
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className=''>
                  <button
                    type='submit'
                    className='flex w-full cursor-pointer items-center justify-center rounded-md border border-primary bg-primary px-5 py-3 text-base text-white transition duration-300 ease-in-out hover:bg-darkmode'>
