  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className='mb-9'>
        <button
          type='submit'
          className='flex w-full cursor-pointer items-center justify-center rounded-md border border-primary bg-[var(--color-dark-blue)] px-5 py-3 text-base text-white transition duration-300 ease-in-out hover:bg-[var(--color-dark-blue)]'>
          Send Magic Link
        </button>
      </div>
    </form>
